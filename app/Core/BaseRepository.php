...
class BaseRepository implements IBaseRepository {
    ...
    /**
     * Get where with closure
     *
     * @param closure $closure
     *
     * @return $this
     */
    public function getWhere($closure) {
        $this->entity = $this->entity->where($closure);
        return $this;
    }
    ...
    public function whereBetween(string $column, array $attributes = []) {
        $this->entity->whereBetween($column, $attributes);
        return $this;
    }
    ...
    public function orWhere(string $column, string $criteria, string $value) {
        $this->entity->orWhere($column, $criteria, $value);
        return $this;
    }
